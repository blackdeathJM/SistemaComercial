...
import {TIniPlaneacion} from "#/libs/models/src/lib/dir-general/planeacion/planeacion.dto";
...
export class PlaneacionService
{
    ...
    filTodos(): Observable<SingleExecutionResult<FilTodosQuery>>
    {
        ...
        {
            console.log('Planeacion service', res);
            if (res.data)
            {
    ...
    inicializarPlaneacion(input: TIniPlaneacion): Observable<SingleExecutionResult<InicializarPlaneacionMutation>>
    {
