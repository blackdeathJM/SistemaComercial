...
import {DIR_COMERCIAL, DIR_COMERCIAL_C, DIR_COMERCIAL_F, DIR_COMERCIAL_H} from '@s-app/common/navigation/dir-comercial';
import {DIR_TECNICA_OPERATIVA, DIR_TECNICA_OPERATIVA_C, DIR_TECNICA_OPERATIVA_F, DIR_TECNICA_OPERATIVA_H} from '@s-app/common/navigation/dir-tecnica-operativa';
import {DIR_ATENCION_COMUNIDADES, DIR_ATENCION_COMUNIDADES_C, DIR_ATENCION_COMUNIDADES_F, DIR_ATENCION_COMUNIDADES_H} from '@s-app/common/navigation/dir-atencion-comunidades';
import {DIR_ARCHIVO_REG, DIR_ARCHIVO_REG_C, DIR_ARCHIVO_REG_F, DIR_ARCHIVO_REG_H} from '@s-app/common/navigation/dir-archivo-reg';
